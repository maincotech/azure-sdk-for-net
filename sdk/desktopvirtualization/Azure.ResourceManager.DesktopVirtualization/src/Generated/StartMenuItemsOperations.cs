...
{
    /// <summary> The StartMenuItems service client. </summary>
    public partial class StartMenuItemsOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly HttpPipeline _pipeline;
        internal StartMenuItemsRestOperations RestClient { get; }
        /// <summary> Initializes a new instance of StartMenuItemsOperations for mocking. </summary>
        protected StartMenuItemsOperations()
        {
        }
        /// <summary> Initializes a new instance of StartMenuItemsOperations. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        internal StartMenuItemsOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2019-12-10-preview")
        {
            RestClient = new StartMenuItemsRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
        ...
        public virtual AsyncPageable<StartMenuItem> ListAsync(string resourceGroupName, string applicationGroupName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("StartMenuItemsOperations.List");
                scope.Start();
                try
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="applicationGroupName"/> is null. </exception>
        public virtual Pageable<StartMenuItem> List(string resourceGroupName, string applicationGroupName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
