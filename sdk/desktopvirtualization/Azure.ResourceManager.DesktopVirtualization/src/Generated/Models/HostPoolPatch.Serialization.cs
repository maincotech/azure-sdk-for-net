...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    public partial class HostPoolPatch : IUtf8JsonSerializable
    {
        ...
        internal static HostPoolPatch DeserializeHostPoolPatch(JsonElement element)
        {
            ...
            return new HostPoolPatch(id.Value, name.Value, type.Value, Optional.ToDictionary(tags), friendlyName.Value, description.Value, customRdpProperty.Value, Optional.ToNullable(maxSessionLimit), Optional.ToNullable(personalDesktopAssignmentType), Optional.ToNullable(loadBalancerType), Optional.ToNullable(ring), Optional.ToNullable(validationEnvironment), registrationInfo.Value, ssoContext.Value, Optional.ToNullable(preferredAppGroupType));
        }
    }
}
