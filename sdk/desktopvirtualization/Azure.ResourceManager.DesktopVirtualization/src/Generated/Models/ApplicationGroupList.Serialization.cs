...
namespace Azure.ResourceManager.DesktopVirtualization.Models
{
    public partial class ApplicationGroupList
    {
        ...
        {
            Optional<IReadOnlyList<ApplicationGroup>> value = default;
            Optional<string> nextLink = default;
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"))
                {
                    List<ApplicationGroup> array = new List<ApplicationGroup>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ApplicationGroup.DeserializeApplicationGroup(item));
                    }
                    value = array;
                    continue;
                }
