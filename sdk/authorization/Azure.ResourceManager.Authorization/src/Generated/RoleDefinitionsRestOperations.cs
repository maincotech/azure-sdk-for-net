...
namespace Azure.ResourceManager.Authorization
{
    internal partial class RoleDefinitionsRestOperations
    {
        ...
        public RoleDefinitionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null, string apiVersion = "2015-07-01")
        {
        ...
        public async Task<Response<RoleDefinition>> GetByIdAsync(string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            if (roleDefinitionId == null)
            {
                throw new ArgumentNullException(nameof(roleDefinitionId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="roleDefinitionId"/> is null. </exception>
        public Response<RoleDefinition> GetById(string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            if (roleDefinitionId == null)
            {
                throw new ArgumentNullException(nameof(roleDefinitionId));
