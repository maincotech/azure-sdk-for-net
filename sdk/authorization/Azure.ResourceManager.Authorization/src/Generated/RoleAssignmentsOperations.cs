...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleAssignmentsOperations
    {
        ...
        internal RoleAssignmentsOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2015-07-01")
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<RoleAssignment>> DeleteByIdAsync(string roleAssignmentId, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleAssignmentsOperations.DeleteById");
            scope0.Start();
            try
            {
                return await RestClient.DeleteByIdAsync(roleAssignmentId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope0.Failed(e);
        ...
        /// <param name="roleAssignmentId"> The fully qualified ID of the role assignment, including the scope, resource name and resource type. Use the format, /{scope}/providers/Microsoft.Authorization/roleAssignments/{roleAssignmentName}. Example: /subscriptions/{subId}/resourcegroups/{rgname}//providers/Microsoft.Authorization/roleAssignments/{roleAssignmentName}. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<RoleAssignment> DeleteById(string roleAssignmentId, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleAssignmentsOperations.DeleteById");
            scope0.Start();
            try
            {
                return RestClient.DeleteById(roleAssignmentId, cancellationToken);
            }
            catch (Exception e)
            {
                scope0.Failed(e);
        ...
        /// <param name="parameters"> Parameters for the role assignment. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<RoleAssignment>> CreateByIdAsync(string roleAssignmentId, RoleAssignmentCreateParameters parameters, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleAssignmentsOperations.CreateById");
            scope0.Start();
            try
            {
                return await RestClient.CreateByIdAsync(roleAssignmentId, parameters, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope0.Failed(e);
        ...
        /// <param name="parameters"> Parameters for the role assignment. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<RoleAssignment> CreateById(string roleAssignmentId, RoleAssignmentCreateParameters parameters, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleAssignmentsOperations.CreateById");
            scope0.Start();
            try
            {
                return RestClient.CreateById(roleAssignmentId, parameters, cancellationToken);
            }
            catch (Exception e)
            {
                scope0.Failed(e);
        ...
        /// <param name="roleAssignmentId"> The fully qualified ID of the role assignment, including the scope, resource name and resource type. Use the format, /{scope}/providers/Microsoft.Authorization/roleAssignments/{roleAssignmentName}. Example: /subscriptions/{subId}/resourcegroups/{rgname}//providers/Microsoft.Authorization/roleAssignments/{roleAssignmentName}. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<RoleAssignment>> GetByIdAsync(string roleAssignmentId, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleAssignmentsOperations.GetById");
            scope0.Start();
            try
            {
                return await RestClient.GetByIdAsync(roleAssignmentId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope0.Failed(e);
        ...
        /// <param name="roleAssignmentId"> The fully qualified ID of the role assignment, including the scope, resource name and resource type. Use the format, /{scope}/providers/Microsoft.Authorization/roleAssignments/{roleAssignmentName}. Example: /subscriptions/{subId}/resourcegroups/{rgname}//providers/Microsoft.Authorization/roleAssignments/{roleAssignmentName}. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<RoleAssignment> GetById(string roleAssignmentId, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleAssignmentsOperations.GetById");
            scope0.Start();
            try
            {
                return RestClient.GetById(roleAssignmentId, cancellationToken);
            }
            catch (Exception e)
            {
                scope0.Failed(e);
