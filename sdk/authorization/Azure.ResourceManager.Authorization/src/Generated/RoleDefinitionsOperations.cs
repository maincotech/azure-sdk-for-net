...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleDefinitionsOperations
    {
        ...
        internal RoleDefinitionsOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null, string apiVersion = "2015-07-01")
        {
            RestClient = new RoleDefinitionsRestOperations(clientDiagnostics, pipeline, endpoint, apiVersion);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<RoleDefinition>> GetByIdAsync(string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleDefinitionsOperations.GetById");
            scope0.Start();
            try
            {
                return await RestClient.GetByIdAsync(roleDefinitionId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope0.Failed(e);
        ...
        /// <param name="roleDefinitionId"> The fully qualified role definition ID. Use the format, /subscriptions/{guid}/providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId} for subscription level role definitions, or /providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId} for tenant level role definitions. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<RoleDefinition> GetById(string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            using var scope0 = _clientDiagnostics.CreateScope("RoleDefinitionsOperations.GetById");
            scope0.Start();
            try
            {
                return RestClient.GetById(roleDefinitionId, cancellationToken);
            }
            catch (Exception e)
            {
                scope0.Failed(e);
