...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class ClassicAdministratorsOperations
    {
        ...
        internal ClassicAdministratorsOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2015-07-01")
        {
            RestClient = new ClassicAdministratorsRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
