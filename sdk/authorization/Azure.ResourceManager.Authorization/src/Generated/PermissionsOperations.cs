...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class PermissionsOperations
    {
        ...
        internal PermissionsOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2015-07-01")
        {
            RestClient = new PermissionsRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
